...
set_target_properties(inflowwind_driver PROPERTIES
  IMPORTED_LOCATION_DEBUG "${_IMPORT_PREFIX}/bin/inflowwind_driver"
  )
...
set_target_properties(ifw_c_binding PROPERTIES
  IMPORTED_LOCATION_DEBUG "${_IMPORT_PREFIX}/lib/libifw_c_binding.so"
  IMPORTED_SONAME_DEBUG "libifw_c_binding.so"
  )

list(APPEND _IMPORT_CHECK_TARGETS ifw_c_binding )
list(APPEND _IMPORT_CHECK_FILES_FOR_ifw_c_binding "${_IMPORT_PREFIX}/lib/libifw_c_binding.so" )
...
set_target_properties(unsteadyaero_driver PROPERTIES
  IMPORTED_LOCATION_DEBUG "${_IMPORT_PREFIX}/bin/unsteadyaero_driver"
  )
...
set_target_properties(aerodyn_driver PROPERTIES
  IMPORTED_LOCATION_DEBUG "${_IMPORT_PREFIX}/bin/aerodyn_driver"
  )
...
# Import target "fvwlib" for configuration "Debug"
set_property(TARGET fvwlib APPEND PROPERTY IMPORTED_CONFIGURATIONS DEBUG)
set_target_properties(fvwlib PROPERTIES
  IMPORTED_LINK_INTERFACE_LANGUAGES_DEBUG "Fortran"
  IMPORTED_LOCATION_DEBUG "${_IMPORT_PREFIX}/lib/libfvwlib.a"
  )

list(APPEND _IMPORT_CHECK_TARGETS fvwlib )
list(APPEND _IMPORT_CHECK_FILES_FOR_fvwlib "${_IMPORT_PREFIX}/lib/libfvwlib.a" )

# Import target "uaaerolib" for configuration "Debug"
set_property(TARGET uaaerolib APPEND PROPERTY IMPORTED_CONFIGURATIONS DEBUG)
set_target_properties(uaaerolib PROPERTIES
  IMPORTED_LINK_INTERFACE_LANGUAGES_DEBUG "Fortran"
  IMPORTED_LOCATION_DEBUG "${_IMPORT_PREFIX}/lib/libuaaerolib.a"
  )
...
# Import target "afinfolib" for configuration "Debug"
set_property(TARGET afinfolib APPEND PROPERTY IMPORTED_CONFIGURATIONS DEBUG)
set_target_properties(afinfolib PROPERTIES
  IMPORTED_LINK_INTERFACE_LANGUAGES_DEBUG "Fortran"
  IMPORTED_LOCATION_DEBUG "${_IMPORT_PREFIX}/lib/libafinfolib.a"
  )
...
# Import target "aeroacoustics" for configuration "Debug"
set_property(TARGET aeroacoustics APPEND PROPERTY IMPORTED_CONFIGURATIONS DEBUG)
set_target_properties(aeroacoustics PROPERTIES
  IMPORTED_LINK_INTERFACE_LANGUAGES_DEBUG "Fortran"
  IMPORTED_LOCATION_DEBUG "${_IMPORT_PREFIX}/lib/libaeroacoustics.a"
  )
...
set_target_properties(servodyn_driver PROPERTIES
  IMPORTED_LOCATION_DEBUG "${_IMPORT_PREFIX}/bin/servodyn_driver"
  )
...
set_target_properties(subdyn_driver PROPERTIES
  IMPORTED_LOCATION_DEBUG "${_IMPORT_PREFIX}/bin/subdyn_driver"
  )
...
set_target_properties(hydrodyn_driver PROPERTIES
  IMPORTED_LOCATION_DEBUG "${_IMPORT_PREFIX}/bin/hydrodyn_driver"
  )
...
set_target_properties(hydrodyn_c_binding PROPERTIES
  IMPORTED_LOCATION_DEBUG "${_IMPORT_PREFIX}/lib/libhydrodyn_c_binding.so"
  IMPORTED_SONAME_DEBUG "libhydrodyn_c_binding.so"
  )

list(APPEND _IMPORT_CHECK_TARGETS hydrodyn_c_binding )
list(APPEND _IMPORT_CHECK_FILES_FOR_hydrodyn_c_binding "${_IMPORT_PREFIX}/lib/libhydrodyn_c_binding.so" )
...
set_target_properties(orca_driver PROPERTIES
  IMPORTED_LOCATION_DEBUG "${_IMPORT_PREFIX}/bin/orca_driver"
  )
...
# Import target "openfoamtypeslib" for configuration "Debug"
set_property(TARGET openfoamtypeslib APPEND PROPERTY IMPORTED_CONFIGURATIONS DEBUG)
set_target_properties(openfoamtypeslib PROPERTIES
  IMPORTED_LINK_INTERFACE_LANGUAGES_DEBUG "Fortran"
  IMPORTED_LOCATION_DEBUG "${_IMPORT_PREFIX}/lib/libopenfoamtypeslib.a"
  )
...
# Import target "scdataextypeslib" for configuration "Debug"
set_property(TARGET scdataextypeslib APPEND PROPERTY IMPORTED_CONFIGURATIONS DEBUG)
set_target_properties(scdataextypeslib PROPERTIES
  IMPORTED_LINK_INTERFACE_LANGUAGES_DEBUG "Fortran"
  IMPORTED_LOCATION_DEBUG "${_IMPORT_PREFIX}/lib/libscdataextypeslib.a"
  )

list(APPEND _IMPORT_CHECK_TARGETS scdataextypeslib )
list(APPEND _IMPORT_CHECK_FILES_FOR_scdataextypeslib "${_IMPORT_PREFIX}/lib/libscdataextypeslib.a" )

# Import target "scdataexlib" for configuration "Debug"
set_property(TARGET scdataexlib APPEND PROPERTY IMPORTED_CONFIGURATIONS DEBUG)
set_target_properties(scdataexlib PROPERTIES
  IMPORTED_LINK_INTERFACE_LANGUAGES_DEBUG "Fortran"
  IMPORTED_LOCATION_DEBUG "${_IMPORT_PREFIX}/lib/libscdataexlib.a"
  )

list(APPEND _IMPORT_CHECK_TARGETS scdataexlib )
list(APPEND _IMPORT_CHECK_FILES_FOR_scdataexlib "${_IMPORT_PREFIX}/lib/libscdataexlib.a" )
...
set_target_properties(openfastlib PROPERTIES
  IMPORTED_LINK_INTERFACE_LANGUAGES_DEBUG "Fortran"
  IMPORTED_LOCATION_DEBUG "${_IMPORT_PREFIX}/lib/libopenfastlib.a"
  )
...
set_target_properties(feam_driver PROPERTIES
  IMPORTED_LOCATION_DEBUG "${_IMPORT_PREFIX}/bin/feam_driver"
  )
...
# Import target "mapcpplib" for configuration "Debug"
set_property(TARGET mapcpplib APPEND PROPERTY IMPORTED_CONFIGURATIONS DEBUG)
set_target_properties(mapcpplib PROPERTIES
  IMPORTED_LINK_INTERFACE_LANGUAGES_DEBUG "C;CXX;Fortran"
  IMPORTED_LOCATION_DEBUG "${_IMPORT_PREFIX}/lib/libmapcpplib.a"
  )
...
list(APPEND _IMPORT_CHECK_TARGETS wdlib )
list(APPEND _IMPORT_CHECK_FILES_FOR_wdlib "${_IMPORT_PREFIX}/lib/libwdlib.a" )
...
list(APPEND _IMPORT_CHECK_TARGETS awaelib )
list(APPEND _IMPORT_CHECK_FILES_FOR_awaelib "${_IMPORT_PREFIX}/lib/libawaelib.a" )
