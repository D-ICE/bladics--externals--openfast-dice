...
diceCaseNames = ["DICE_EXTRA_TEST_5MW_OC3Spar_DLL_WTurb_WavesIrr"]

if caseName not in diceCaseNames:
    raise(ValueError(f"Case {caseName} is not a dice case.\nList of dice cases : {diceCaseNames}"))
